...
// }
export const restfulFormat = (url, param) => {
  var formatString = function (str, replacements) {
    param = (typeof param === 'object') ? param : Array.prototype.slice.call(arguments, 1)
    return str.replace(/\{\{|\}\}|\{(\w+)\}/g, function (m, n) {
      if (m === '{{') { return '{' }
      if (m === '}}') { return '}' }
      return param[n]
  ...
  param = (typeof param === 'object') ? param : Array.prototype.slice.call(arguments, 0)
  return formatString(url, param)
}
