...
module.exports = {
  dev: {
    ...
    port: 8601, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
  ...
  build: {
    ...
    // assetsSubDirectory: 'static',
    // assetsPublicPath: 'http://production-cdn-points.jifentoutiao.com/',
